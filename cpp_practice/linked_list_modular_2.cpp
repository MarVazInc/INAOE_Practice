...
int main()  {
    ...
    //Edge Case 1: Imprime 0 y luego linea --- no se cuelga al eliminar
    /*
    cout << buscar(head,10) << endl;
    eliminar(head,10);
    imprimir(head);
    */

    //Edge Case 2: Imprime 10 luego linea --- y luego 0
    /*
    ...
    */
    ...
    //Edge Case 3: Eliminar primer nodo head
    /*
    insertar_inicio(head,30);
    insertar_inicio(head,20);
    insertar_inicio(head,10);
    imprimir(head);
    eliminar(head,10);
    imprimir(head);
    */
    ...
    //Edge Case 4: Eliminar ultimo nodo head
    /*
    insertar_inicio(head,30);
    insertar_inicio(head,20);
    insertar_inicio(head,10);
    ...
    */
    ...
    //Edge Case 5: Eliminar nodo inexistente se imprime la misma lista
